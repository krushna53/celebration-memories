...
export type BillingProvider = "stripe" | "razorpay" | "ccavenue";
 ...
 * Defaults to 'stripe'. All three processors' credentials can be
 * present at once; only this setting decides which one is actually
 * offered to hosts at checkout time.
 */
