...
const PERSONAS: Persona[] = [
  {
    ...
    canDo: [
      ...
      "Join a digital party game (Word Search, Housie, Movie Name Housie) or help plan via a shared family link — both work from a scanned QR code or link, no account needed",
  ...
  },
  {
    ...
    canDo: [
      ...
      "Run a shared to-do/notes planner and invite family to help, via one link — no separate logins",
      "Create digital party games (Word Search, Housie, Movie Name Housie) with a shareable QR code",
      "Generate a shareable invitation image (manual or AI, capped per event)",
      "Generate an AI slideshow video from the gallery (capped per event)",
    ],
    pages: [
